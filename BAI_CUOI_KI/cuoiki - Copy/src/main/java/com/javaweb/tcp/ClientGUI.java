...
public class ServerGUI {
    ...
    private JButton btnStartServer;private JTextArea textArea;
...
// blackList.add("127.0.0.1");
    ...
    private void initialize() {
        ...
        JScrollPane scrollPane = new JScrollPane();scrollPane.setBounds(20, 50, 450, 300);
    ...
    private class ClientHandler extends Thread {private final Socket clientSocket;
...
// Handle the received request
        ...
        private void sendImage(Socket clientSocket) {
            ...
            try (BufferedInputStream fileInputStream = new BufferedInputStream(new

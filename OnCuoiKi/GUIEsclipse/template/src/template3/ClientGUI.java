...
public class ClientGUI {
    ...
    private JLabel lblRequestToServer_1;
    ...
    private void initialize() {
        ...
        lblResponseOfServer.setBounds(29, 100, 131, 13);
        ...
        lblRequestToServer_1 = new JLabel("Request to server");
        lblRequestToServer_1.setBounds(27, 77, 92, 13);
        frame.getContentPane().add(lblRequestToServer_1);
        
        textField_2 = new JTextField();
        textField_2.setColumns(10);
        textField_2.setBounds(127, 74, 204, 19);
